...
%% ---- Generate the required calliberated sine wave values ---- %%

% Plotting variables
X_AXIS_STEP_COUNTER              = 0;
...
for SINE_VALUE = SINE_Y_DYNAMIXEL_FORMAT
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID1, ADDR_PRO_GOAL_POSITION, SINE_VALUE);
    write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID2, ADDR_PRO_GOAL_POSITION, SINE_VALUE);
